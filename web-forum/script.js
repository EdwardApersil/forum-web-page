        ...
        post.user.name
            ...
            <div class="card-body">
              ...
              <p class="content my-6">${post.content.substring(
                0,
                350
              )} <button class="text-blue-500 read-more" data-full-text="${
        post.content
      }">Read More</button></p>
            </div>
            <div class="card-footer">
              <p class="category rounded-md category-color">${post.category}</p>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-6 h-6 mx-4 like">
                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    followButtons.forEach((button) => {
      button.addEventListener("click", () => {
        ...
        if (button.textContent === "Following") {
          button.style.background = "#EAB313";
        } else {
